...
window.addToCart        = (name,price)=>{ if(!cart[name]) cart[name]={qty:0,price}; cart[name].qty++; renderCart(); shakeCart(); };
...
// ปุ่มเขย่า (shake) ตะกร้า
function shakeCart(){
  const c = document.getElementById('cart-icon-box');
